...
int main(void)
{
	...
	const int side_x = 5;
	const int side_y = 5;
	const int times_to_play = 1000;
	const int yellow_points_number = 3;
	...
	//step[4.0.]: using "for" for playing this fucking game "times_to_play" times, BITCH!!!
	...
	system("cls");//clean anything fuck out!!!
	...
	cout<<"Yes, i'm Electrinic Arts and I want to eat your money"<<endl;//it's a prank, bro. I JUST HAVE A CANCER!!! :D
